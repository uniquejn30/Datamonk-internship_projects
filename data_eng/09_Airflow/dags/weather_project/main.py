...
--> Loads the list of cities from indian_cities.csv by just itreating over the city column in the csv file you can pass the city name for your further process. (download the csv file from here ~~ indian_cities.csv)
...
def run_etl(date):
    ...
    # Step 2: Load cities
    with open("indian_cities.csv", "r") as f:
